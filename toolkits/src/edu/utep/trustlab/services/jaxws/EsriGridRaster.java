...
@XmlRootElement(name = "esriGridRaster", namespace = "http://services.trustlab.utep.edu/")
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "esriGridRaster", namespace = "http://services.trustlab.utep.edu/", propOrder = {"url", "font", "lbOrientation", "colorTable"})

public class EsriGridRaster {

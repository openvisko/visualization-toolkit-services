...
public class SurfacePlotter{
	...
	//added by Nick D
	public void setImage(ImagePlus anImg){
		img = anImg;
		lut = img.createLut();
	}	
	...
	public void setParameters(
		...
		SurfacePlotter.plotWidth = plotWidth;
		SurfacePlotter.polygonMultiplier = polygonMultiplier;		
		SurfacePlotter.showWireframe=showWireframe;
		SurfacePlotter.showGrayscale=showGrayscale;
		SurfacePlotter.showAxis=showAxis;
		SurfacePlotter.whiteBackground=whiteBackground;
		SurfacePlotter.blackFill=blackFill;
		SurfacePlotter.smooth = smooth;
	}

...
@WebService(targetNamespace="http://gmtTrustLab/", serviceName="GMTGravityTransformersUsingParameters")
...
public class GMTServices{
	...
	public String PDFToPNG(@WebParam(name="url") String url){
		PDFToPNG service = new PDFToPNG(url);
		return service.transform();
	}
	
	public String PSToPDF(@WebParam(name="url") String url){
		PSToPDF service = new PSToPDF(url);
		return service.transform();
	}
	
	public String PSFToPNG(@WebParam(name = "url") String url){
		PSToPNG service = new PSToPNG(url);
		return service.transform();
	}
	
	public String CSVToTabularASCII(@WebParam(name = "url") String url){

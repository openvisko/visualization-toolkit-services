package edu.utep.trustlab.toolkitOperators.vtk.util;
...
public class FileUtils
{
	...
	{
		return "/usr/local/tomcat/webapps/VTK-services/log/";
	}
	
	public static String getGravityMapWorkspaceDir()
	{
		return "/usr/local/tomcat/webapps/VTK-services/gravityMapOutput/";
	}
	
	public static String getHolesVisWorkspaceDir()
	{
		return "/usr/local/tomcat/webapps/VTK-services/holesVisOutput/";
	}
	
	public static String getGravityMapURLPrefix()
	{
		return "http://minas.cs.utep.edu:8080/VTK-services/gravityMapOutput/";
	}
	
	public static String getHolesVisURLPrefix()
	{
		return "http://iw.cs.utep.edu:8080/VTK-services/holesVisOutput/";
	}
